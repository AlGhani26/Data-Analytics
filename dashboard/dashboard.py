...
ax.set_ylabel('Total Penyewaan')
ax.set_title('Total Penyewaan Sepeda untuk Setiap Jam dalam Sehari (2011-2012)')
st.pyplot(fig)
...
ax.set_ylabel('Total Penyewaan')
ax.set_title('Perbandingan Penyewaan Sepeda pada Holiday, Workday, dan Weekend')
plt.gca().yaxis.set_major_formatter(FuncFormatter(lambda x, _: f'{int(x):,}'))
st.pyplot(fig)
